...
export const Navbar = () => {
  return (
      <nav
          className="bg-fabflix- dark:bg-fabflix-primary fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
          <div className="max-w-screen-xl flex items-center justify-between mx-auto p-4">
              <Link to="/" className="flex items-center space-x-2">
                  <img
                      ...
                      className="h-8" alt="Fabflix Logo"/>
                  <h1 className="text-4xl font-bold  text-gray-900 dark:text-white">Fabflix</h1>
              </Link>

              <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                  <Link to="/search" className="flex items-center space-x-3 rtl:space-x-reverse">
                      <img src="https://img.icons8.com/m_outlined/512/FFFFFF/search.png" className="h-8"
                           alt="Search"/>
                  </Link>
              </div>
