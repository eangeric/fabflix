...
function handleMovieResult(resultData) {
    ...
    for (let i = 0; i < resultData.length; i++) {
        ...
        rowHTML += `<td><a href="../single-movie/single-movie.html?id=${resultData[i].movies_id}">${resultData[i].movie_title}</a></td>`;
...
jQuery.ajax({
    ...
    url: `/${basePath}/api/movies`, // Setting request url, which is mapped by StarsServlet in Stars.java
